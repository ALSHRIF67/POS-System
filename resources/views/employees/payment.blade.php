...
<main id="mainContent" class="main-content min-h-screen bg-[#f8fafc]">
    <div class="content-container">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 max-w-2xl mx-auto">
            <form method="POST" action="{{ route('employees.payment.store', $employee) }}">
                @csrf

                <!-- Employee Info Summary (optional) -->
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" 
                            class="px-6 py-3 bg-green-500 text-white rounded-xl font-bold hover:bg-green-600 transition touch-button">
